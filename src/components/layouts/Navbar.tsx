  ...
  return (
    <nav className="flex py-4 md:py-5 px-6 md:px-15 items-center justify-between w-full">
      <div className="flex items-center gap-3 md:gap-4">
        <Button className="bg-transparent border-1 border-white rounded-full h-12 w-12 md:h-15 md:w-15 p-0 flex items-center justify-center hover:bg-white hover:text-black transition-colors">
      ...
      <Button className="bg-transparent border-1 border-white h-12 md:h-15 px-4 sm:px-6 md:px-10 rounded-full flex items-center gap-2 hover:bg-white hover:text-black transition-colors">
